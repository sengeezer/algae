...
- The catalog currently includes 384 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 384-entry core toward the broader launch target.
