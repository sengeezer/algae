...
- The catalog currently includes 98 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 98-entry core toward the broader launch target.
