...
- The catalog currently includes 572 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 572-entry core toward the broader launch target.
