...
- The catalog currently includes 581 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 581-entry core toward the broader launch target.
