...
- The catalog currently includes 787 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 787-entry core toward the broader launch target.
