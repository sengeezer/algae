...
- The catalog currently includes 471 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 471-entry core toward the broader launch target.
