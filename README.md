...
- The catalog currently includes 146 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 146-entry core toward the broader launch target.
