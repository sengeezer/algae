...
- The catalog currently includes 278 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 278-entry core toward the broader launch target.
