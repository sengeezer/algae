...
- The catalog currently includes 396 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 396-entry core toward the broader launch target.
