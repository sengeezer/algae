...
- The catalog currently includes 511 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 511-entry core toward the broader launch target.
