...
- The catalog currently includes 393 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 393-entry core toward the broader launch target.
