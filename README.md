...
- The catalog currently includes 740 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 740-entry core toward the broader launch target.
