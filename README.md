...
- The catalog currently includes 254 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 254-entry core toward the broader launch target.
