...
- The catalog currently includes 354 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 354-entry core toward the broader launch target.
