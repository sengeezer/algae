...
- The catalog currently includes 366 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 366-entry core toward the broader launch target.
