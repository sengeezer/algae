...
- The catalog currently includes 194 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 194-entry core toward the broader launch target.
