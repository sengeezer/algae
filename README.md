...
- The catalog currently includes 420 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 420-entry core toward the broader launch target.
