...
- The catalog currently includes 248 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 248-entry core toward the broader launch target.
