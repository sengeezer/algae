...
- The catalog currently includes 200 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 200-entry core toward the broader launch target.
