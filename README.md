...
- The catalog currently includes 758 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 758-entry core toward the broader launch target.
