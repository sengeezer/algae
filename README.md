...
- The catalog currently includes 652 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 652-entry core toward the broader launch target.
