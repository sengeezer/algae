...
- The catalog currently includes 236 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 236-entry core toward the broader launch target.
