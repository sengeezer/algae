...
- The catalog currently includes 336 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 336-entry core toward the broader launch target.
