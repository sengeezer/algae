...
- The catalog currently includes 86 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 86-entry core toward the broader launch target.
