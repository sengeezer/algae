...
- The catalog currently includes 122 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 122-entry core toward the broader launch target.
