...
- The catalog currently includes 326 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 326-entry core toward the broader launch target.
