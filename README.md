...
- The catalog currently includes 284 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 284-entry core toward the broader launch target.
