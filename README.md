...
- The catalog currently includes 646 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 646-entry core toward the broader launch target.
