...
- The catalog currently includes 640 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 640-entry core toward the broader launch target.
