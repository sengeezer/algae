...
- The catalog currently includes 429 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 429-entry core toward the broader launch target.
