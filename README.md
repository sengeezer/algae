...
- The catalog currently includes 296 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 296-entry core toward the broader launch target.
