...
- The catalog currently includes 260 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 260-entry core toward the broader launch target.
