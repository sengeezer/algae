...
- The catalog currently includes 116 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 116-entry core toward the broader launch target.
