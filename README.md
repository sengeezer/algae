...
- The catalog currently includes 405 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 405-entry core toward the broader launch target.
