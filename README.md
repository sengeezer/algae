...
- The catalog currently includes 378 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 378-entry core toward the broader launch target.
