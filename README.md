...
- The catalog currently includes 597 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 597-entry core toward the broader launch target.
