...
- The catalog currently includes 206 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 206-entry core toward the broader launch target.
