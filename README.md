...
- The catalog currently includes 188 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 188-entry core toward the broader launch target.
