...
- The catalog currently includes 426 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 426-entry core toward the broader launch target.
