...
- The catalog currently includes 182 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 182-entry core toward the broader launch target.
