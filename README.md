...
- The catalog currently includes 272 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 272-entry core toward the broader launch target.
