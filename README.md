...
- The catalog currently includes 752 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 752-entry core toward the broader launch target.
