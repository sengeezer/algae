...
- The catalog currently includes 104 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 104-entry core toward the broader launch target.
