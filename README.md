...
- The catalog currently includes 176 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 176-entry core toward the broader launch target.
