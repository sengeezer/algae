...
- The catalog currently includes 564 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 564-entry core toward the broader launch target.
