...
- The catalog currently includes 770 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 770-entry core toward the broader launch target.
