...
- The catalog currently includes 242 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 242-entry core toward the broader launch target.
