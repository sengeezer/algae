...
- The catalog currently includes 749 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 749-entry core toward the broader launch target.
