...
- The catalog currently includes 164 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 164-entry core toward the broader launch target.
