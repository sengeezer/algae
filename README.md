...
- The catalog currently includes 621 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 621-entry core toward the broader launch target.
