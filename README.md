...
- The catalog currently includes 580 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 580-entry core toward the broader launch target.
