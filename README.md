...
- The catalog currently includes 128 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 128-entry core toward the broader launch target.
