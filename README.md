...
- The catalog currently includes 530 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 530-entry core toward the broader launch target.
