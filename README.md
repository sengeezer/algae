...
- The catalog currently includes 764 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 764-entry core toward the broader launch target.
