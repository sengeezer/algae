...
- The catalog currently includes 664 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 664-entry core toward the broader launch target.
