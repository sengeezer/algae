...
- The catalog currently includes 637 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 637-entry core toward the broader launch target.
