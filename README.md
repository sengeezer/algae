...
- The catalog currently includes 56 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 56-entry core toward the broader launch target.
