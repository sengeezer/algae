...
- The catalog currently includes 402 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 402-entry core toward the broader launch target.
