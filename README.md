...
- The catalog currently includes 212 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 212-entry core toward the broader launch target.
