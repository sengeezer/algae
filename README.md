...
- The catalog currently includes 372 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 372-entry core toward the broader launch target.
