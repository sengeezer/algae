...
- The catalog currently includes 631 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 631-entry core toward the broader launch target.
