...
- The catalog currently includes 37 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 37-entry core toward the broader launch target.
