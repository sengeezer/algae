...
- The catalog currently includes 527 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 527-entry core toward the broader launch target.
