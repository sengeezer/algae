...
- The catalog currently includes 266 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 266-entry core toward the broader launch target.
