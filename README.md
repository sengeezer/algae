...
- The catalog currently includes 92 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 92-entry core toward the broader launch target.
