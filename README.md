...
- The catalog currently includes 520 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 520-entry core toward the broader launch target.
