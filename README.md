...
- The catalog currently includes 230 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 230-entry core toward the broader launch target.
