...
- The catalog currently includes 408 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 408-entry core toward the broader launch target.
