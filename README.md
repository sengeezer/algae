...
- The catalog currently includes 74 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 74-entry core toward the broader launch target.
