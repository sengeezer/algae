...
- The catalog currently includes 290 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 290-entry core toward the broader launch target.
