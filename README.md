...
- The catalog currently includes 140 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 140-entry core toward the broader launch target.
