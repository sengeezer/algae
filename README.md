...
- The catalog currently includes 320 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 320-entry core toward the broader launch target.
