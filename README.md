...
- The catalog currently includes 62 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 62-entry core toward the broader launch target.
