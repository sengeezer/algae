...
- The catalog currently includes 50 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 50-entry core toward the broader launch target.
