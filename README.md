...
- The catalog currently includes 308 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 308-entry core toward the broader launch target.
