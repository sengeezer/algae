...
- The catalog currently includes 519 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 519-entry core toward the broader launch target.
