...
- The catalog currently includes 218 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 218-entry core toward the broader launch target.
