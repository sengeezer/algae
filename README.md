...
- The catalog currently includes 605 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 605-entry core toward the broader launch target.
