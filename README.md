...
- The catalog currently includes 549 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 549-entry core toward the broader launch target.
