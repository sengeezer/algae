...
- The catalog currently includes 170 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 170-entry core toward the broader launch target.
