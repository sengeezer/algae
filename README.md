...
- The catalog currently includes 670 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 670-entry core toward the broader launch target.
