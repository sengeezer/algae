...
- The catalog currently includes 649 MDX-backed interview-core algorithms.
...
- Expand the catalog from the current 649-entry core toward the broader launch target.
